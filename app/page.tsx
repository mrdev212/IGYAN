            ...
            <div className="max-w-container-max mx-auto px-margin-desktop text-center relative z-10">
                <div className="scroll-reveal flex flex-col items-center">
                    ...
                    <h1
                        ...
                        One AI-native OS for how your school teaches, tracks, and grows talent.
                    </h1>
                    {/* Subheadline */}
                    <p
                        className="font-body-lg text-body-lg text-slate-700 dark:text-slate-300 max-w-2xl mb-8 leading-relaxed">
                        Find your <span className="font-semibold text-[#3B1595] dark:text-indigo-300">&quot;wow!&quot;</span> this school year with personalized learning, career pathways, and entrepreneurship readiness.
                    </p>
                    {/* Buttons */}
        ...
        <section
            ...
            <div className="max-w-container-max mx-auto px-margin-desktop text-center relative z-10 scroll-reveal">
                ...
                <p
                    ...
                    Join forward-thinking institutions across India in deploying the first AI-native operating system for
                    modern talent.
                </p>
