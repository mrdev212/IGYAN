  ...
  return (
    <div className="bg-surface dark:bg-slate-950 text-slate-900 dark:text-slate-100 min-h-screen flex selection:bg-indigo-100 dark:selection:bg-indigo-900/50 selection:text-trust-blue dark:selection:text-indigo-300 transition-colors duration-300">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-indigo-950 overflow-hidden items-center justify-center p-12">
        ...
        <div className="absolute inset-0 bg-gradient-to-tr from-[#00AEEF]/30 via-indigo-900 to-purple-900 opacity-90 z-10"></div>
        <div className="absolute -top-32 -left-32 w-[600px] h-[600px] bg-purple-600 rounded-full blur-[150px] opacity-40 mix-blend-screen z-0 animate-pulse"></div>
        <div className="absolute -bottom-32 -right-32 w-96 h-96 bg-[#0047AB] rounded-full blur-[120px] opacity-50 mix-blend-screen z-0"></div>
        ...
        <div className="relative z-20 flex flex-col justify-between h-full w-full max-w-lg">
          ...
          <div className="mt-16 mb-auto">
            <h1 className="font-headline-xl text-5xl font-extrabold text-white leading-tight mb-6 tracking-tight">
              Start your<br/>AI journey today.
            </h1>
            <p className="text-indigo-200 text-lg leading-relaxed max-w-md font-body-md">
              Create an account to unlock intelligent tools for students, teachers, parents, and institutions.
            </p>
            ...
            <div className="mt-10 space-y-4">
              <div className="flex items-center gap-3 text-indigo-100">
                <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center shrink-0 border border-white/20">
                  <span className="material-symbols-outlined text-[16px] text-[#00AEEF]">check</span>
                </div>
                <span className="font-medium text-sm">Personalized learning dashboards</span>
              </div>
              <div className="flex items-center gap-3 text-indigo-100">
                <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center shrink-0 border border-white/20">
                  <span className="material-symbols-outlined text-[16px] text-purple-300">check</span>
                </div>
                <span className="font-medium text-sm">Automated workflow and grading</span>
              </div>
              <div className="flex items-center gap-3 text-indigo-100">
                <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center shrink-0 border border-white/20">
                  <span className="material-symbols-outlined text-[16px] text-pink-300">check</span>
                </div>
                <span className="font-medium text-sm">Real-time progress insights</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-auto flex items-center gap-4">
            <div className="flex -space-x-3">
              <img className="w-10 h-10 rounded-full border-2 border-indigo-900 object-cover" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="User 1"/>
              <img className="w-10 h-10 rounded-full border-2 border-indigo-900 object-cover" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="User 2"/>
              <img className="w-10 h-10 rounded-full border-2 border-indigo-900 object-cover" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="User 3"/>
              <img className="w-10 h-10 rounded-full border-2 border-indigo-900 object-cover" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="User 4"/>
            </div>
            <div className="text-indigo-200 text-sm font-medium">
              Join over <strong className="text-white">10,000+</strong> educators and students.
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 xl:p-16 relative bg-surface dark:bg-slate-950 overflow-y-auto">
        {/* Back Button Mobile */}
        ...
        <div className="w-full max-w-[420px] mx-auto py-10 animate-[fadeIn_0.5s_ease-out]">
          <div className="text-center lg:text-left mb-8">
            <h2 className="font-headline-xl text-3xl sm:text-4xl font-extrabold text-slate-900 dark:text-white mb-3">Create an account</h2>
            <p className="text-slate-500 dark:text-slate-400 font-body-md">Fill in the details below to get started.</p>
          </div>
          ...
          <div className="relative flex py-2 items-center mb-6">
            ...
            <span className="flex-shrink-0 mx-4 text-slate-400 dark:text-slate-500 text-xs uppercase tracking-wider font-semibold">Or register with email</span>
            <div className="flex-grow border-t border-slate-200 dark:border-slate-800"></div>
          </div>
          ...
          <form action={signup} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="first-name" className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1">
                  First name
                </label>
              ...
              {/* Last Name */}
              <div className="flex flex-col gap-1.5">
                <label htmlFor="last-name" className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1">
                  Last name
                </label>
            ...
            {/* Account Type */}
            <div className="flex flex-col gap-1.5">
              <label htmlFor="role" className="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1">
                Account Type
              </label>
              <CustomSelect 
                name="role" 
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input type="password" id="password" name="password" required placeholder="Enter a secure password" minLength={6}
                className="w-full bg-transparent border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-3 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-trust-blue/20 dark:focus:ring-indigo-500/20 focus:border-trust-blue dark:focus:border-indigo-400 transition-all font-body-md shadow-sm" />
            </div>

            <div className="flex items-start pt-1">
              <div className="flex items-center h-5">
                <input id="terms" name="terms" type="checkbox" required className="h-4 w-4 text-trust-blue dark:text-indigo-500 focus:ring-trust-blue dark:focus:ring-indigo-500 border-slate-300 dark:border-slate-700 rounded bg-transparent transition-colors cursor-pointer mt-0.5" />
              </div>
          ...
          <p className="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
            ...
            <Link href="/login" className="font-bold text-trust-blue dark:text-indigo-400 hover:text-indigo-600 dark:hover:text-indigo-300 transition-colors">
              Sign in here
            </Link>
          </p>
        </div>
